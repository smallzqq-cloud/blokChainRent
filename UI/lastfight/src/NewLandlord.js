...
import UploadIpfs from './Layout/UploadIpfs';
...
export default class NewLandlord extends Component {
            ...
            <Content style={{ padding: '0 ', }}>
                <div
                    ...
                    <div className='land-form'>
                        ...
                        <div className='newland-input-box'>
                            <UploadIpfs inputValues={this.state} onValueChange={this.handleValueChange} ></UploadIpfs>
                        </div>

...
const UploadIpfs = (props) => {
    ...
    const sendTx = async (toeknUrl) => {
        ...
        console.log("tokenUrl", toeknUrl);
      
        contract.methods.registerLandlord(landlordname, gender, phone, idCard, toeknUrl).send({ from: window.ethereum.selectedAddress })
    ...
    return (
        ...
        <div className='MintNFT'>
            ...
            <div className='mintNFT' >
                <Button style={{ width: '225px', height: '100px', position: 'absolute', top: '750px' }} onClick={e => mintNFTToken(e, uploadedFile)}>成为房东</Button>
            </div>
        </div>
